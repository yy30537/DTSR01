...
#define ArchitecturalAnalysisPkg_I_SS_SS_getState_SERIALIZE OM_NO_OP

#define ArchitecturalAnalysisPkg_I_SS_SS_setState_SERIALIZE aomsmethod->addAttribute("argState", x2String(argState));
//#]
