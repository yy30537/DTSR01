...
IOxfReactive::TakeEventStatus Lights::rootState_processEvent() {
    ...
    switch (rootState_active) {
        ...
        case state_0:
        {
            if(IS_EVENT_TYPE_OF(Occupant_in_Room_ArchitecturalAnalysisPkg_id))
                {
            ...
            else if(IS_EVENT_TYPE_OF(turn_On_Lights_ArchitecturalAnalysisPkg_id))
                {
        ...
        case LightsOn:
        {
            if(IS_EVENT_TYPE_OF(No_Occupant_in_Room_ArchitecturalAnalysisPkg_id))
                {
            ...
            else if(IS_EVENT_TYPE_OF(turn_Off_Lights_ArchitecturalAnalysisPkg_id))
                {
